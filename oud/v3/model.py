...
def plot_profiel(params):
    ...
    # DROGE BERGING
    ax.add_patch(Rectangle((x0 + 1, hoogte_droge_berging - 0.05), 3, 0.1, color="#f0e6c8"))
    ...
    # WONING
    ax.add_patch(Rectangle((x0 + 13, vloerpeil - 0.05), 5, 0.1, color="orange"))
...
def plot_ruimtebeslag(ruimte):
    ...
    legenda_labels = ["Open water", "Groen", "Droge berging", "Onverhard overig"]
